...
## 5. ASE statistics for *smd3a* and *smd3b* mutant: Figure S6J,K ####
library(openxlsx)
library(ggplot2)
library(ggpubr)
...
#ggsave("FigureS6J.pdf", width = 6, height = 8, units = "cm")
...
#ggsave("FigureS6K.pdf", width = 18, height = 15, units = "cm")
